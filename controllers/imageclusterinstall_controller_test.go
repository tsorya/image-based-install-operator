...
var _ = Describe("Reconcile", func() {
	...
	It("sets the ClusterInstallRequirementsMet condition to false when the host is missing", func() {
		clusterInstall.Spec.BareMetalHostRef = &v1alpha1.BareMetalHostReference{
			Name:      "test-bmh",
			Namespace: "test-bmh-namespace",
		}
	...
	It("fails in case there is no actual bmh under the reference", func() {
		bmh := bmhInState(bmh_v1alpha1.StateAvailable)
		clusterInstall.Spec.BareMetalHostRef = &v1alpha1.BareMetalHostReference{
			Name:      bmh.Name,
			Namespace: bmh.Namespace,
